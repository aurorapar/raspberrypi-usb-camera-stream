...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--file-type', help="Format for pictures taken", default='.png')
    parser.add_argument('-w', '--wait-time', help="Time in seconds between testing images", type=int, default=5)
    parser.add_argument('-d', '--destination-server', help="Destination host for image processing")
    ...
    pi_camera = camera_objects[args.camera_type](
        flip=args.flip,
